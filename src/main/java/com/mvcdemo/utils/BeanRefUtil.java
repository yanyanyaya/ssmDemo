...
public class BeanRefUtil {
	        ...
	        for (Field field : fields) {    
	            try {    
	                ...
	                Method fieldSetMet = cls.getMethod(fieldSetName, field    
	                        .getType());    
	                String value = valMap.get(field.getName()).toString();    
	     ...
	     */
	    public static void setFieldValue(Object bean,String jsonStr) throws JSONException{
	    	setFieldValue(bean,jsonParse(jsonStr));
	    }
		...
		public static HashMap<String,Object> jsonParse(String jsonStr) throws JSONException{
